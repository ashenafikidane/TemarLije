...
public class GroupAddAdapter extends RecyclerView.Adapter<GroupAddAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            name = (TextView) view.findViewById(R.id.studentname2);
            ID = (TextView) view.findViewById(R.id.studentID2);
            profile_img = (CircleImageView) view.findViewById(R.id.profile_image2);
            selection = (CheckBox) view.findViewById(R.id.checkbox2);
    ...
    public GroupAddAdapter(List<Students> studentsList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.group_add_row, parent, false);
